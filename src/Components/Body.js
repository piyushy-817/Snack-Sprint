    ...
    <div className={`${isDarkMode ? "bg-gray-700"  : "bg-white"} flex-grow `}>
      ...
      >
        ...
        <button
          ...
          }  text-slate-500 py-1 px-2 mr-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 hover:bg-red-300 border-double border-4 border-red-100 items-center rounded-xl active:bg-red-400 hover:text-white  cursor-pointer`}
        >
          Search
        </button>
